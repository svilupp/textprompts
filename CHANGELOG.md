...
### Changed
- TypeScript package now builds both ESM and CJS bundles via Bun with declarations generated by `tsup`.
- Default metadata mode in the TypeScript package is now `allow`, parsing metadata automatically when it's provided.
